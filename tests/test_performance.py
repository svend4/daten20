        ...
        def insert_service():
            service = ServiceConfig(
                basic_info=BasicInfo(
                    service_name=sample_service_data['service_name'],
                    region=sample_service_data['region']
                ),
...
class TestAuditLogPerformance:
    ...
    def test_audit_log_write(self, benchmark):
        ...
        from src.core.audit import get_audit_logger, AuditAction, AuditLevel
...
class TestWebhookPerformance:
    ...
    def test_webhook_signature_generation(self, benchmark):
        ...
        from src.core.webhooks import WebhookManager, WebhookConfig, WebhookEvent
