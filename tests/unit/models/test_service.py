...
class TestServiceModel:
    ...
    def service_data(self):
        ...
        from src.models.service import BasicInfo, Funding, SystemSettings
...
class TestBasicInfo:
    ...
    def test_basic_info_contact_validation(self):
        ...
        try:
            ...
            valid_data = {"service_name": "Test", "responsible_person": "John Doe", "provider_type": "Healthcare"}
...
class TestFunding:
    ...
    def funding_data(self):
        ...
        return {"payer": "Federal Grant Agency", "documents": ["contract.pdf", "budget.xlsx"]}
    ...
    def test_funding_amount_validation(self):
        ...
        try:
            ...
            # Test with payer
            data = {"payer": "Insurance Company", "documents": []}
    ...
    def test_funding_amount_formatting(self, payer, num_docs):
        ...
        try:
            ...
            funding_data = {"payer": payer, "documents": [f"doc{i}.pdf" for i in range(num_docs)]}
...
class TestModelRelationships:
    ...
    def test_service_has_basic_info(self):
        ...
        try:
            from src.models.service import BasicInfo, Service

            info_data = {"service_name": "Test Service"}
            info = BasicInfo(**info_data)

            service_data = {"name": "Test Service", "basic_info": info}
    ...
    def test_service_has_funding(self):
        ...
        try:
            from src.models.service import Funding, Service

            funding_data = {"source": "Grant", "amount": 50000.00}
            funding = Funding(**funding_data)

            service_data = {"name": "Test Service", "funding": funding}
