...
class TestTemplateField:
    ...
    @pytest.mark.parametrize("field_type", ["text", "number", "date", "email", "select", "checkbox", "textarea"])
    def test_template_field_types(self, field_type):
        """Test TemplateField supports various field types"""
        try:
            from src.models.template import TemplateField

            field_data = {"name": f"test_{field_type}", "field_type": field_type}
    ...
    def test_template_field_validation_rules(self, field_data):
        ...
        try:
            ...
            validation_rules = {"min_length": 5, "max_length": 100, "pattern": r"^[A-Za-z]+$"}
...
class TestTemplateValidation:
    ...
    def test_validate_required_field(self):
        ...
        try:
            ...
            required_field = TemplateField(name="required", required=True)
    ...
    def test_validate_field_length(self):
        ...
        try:
            ...
            field = TemplateField(name="limited", validation_rules={"min_length": 5, "max_length": 10})
...
class TestTemplateRelationships:
    ...
    def test_template_has_fields(self):
        ...
        try:
            ...
            template_data = {"name": "Test Template", "fields": [field1, field2]}
...
class TestTemplateSerialization:
    ...
    def test_template_to_dict(self):
        ...
        try:
            ...
            template_data = {"name": "Test Template", "version": "1.0", "is_active": True}
    ...
    def test_template_from_dict(self):
        ...
        try:
            ...
            data = {"name": "From Dict", "version": "2.0"}
