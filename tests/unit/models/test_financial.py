...
class TestFinancialData:
    ...
    @pytest.mark.parametrize("budget,actual,expected_status", [
    ...
    def test_financial_data_validation(self):
        ...
        try:
            ...
            invalid_data = {
                'revenue': -1000.00,  # Should be positive
                'expenses': -500.00   # Should be positive
            }
...
class TestFinancialCalculations:
    ...
    @pytest.mark.parametrize("amount,rate,periods,expected", [
        (1000, 0.05, 1, 1050),
        (1000, 0.10, 2, 1210),
        (5000, 0.03, 3, 5463.64),
    ])
