...
class TestAdvancedAnalytics:
    ...
    def test_detect_anomalies_insufficient_data(self, analytics):
        ...
        services = [
            {'brutto_rate': 50.0, 'created_at': datetime(2024, 1, i).isoformat()}
            for i in range(1, 6)
        ]
    ...
    def test_detect_anomalies_with_outliers(self, analytics):
        ...
        # Add clear outliers
        services.append({
            'brutto_rate': 150.0,  # Way above normal
            'created_at': (base_date + timedelta(days=50)).isoformat()
        })
        services.append({
            'brutto_rate': 200.0,  # Even higher
    ...
    def test_generate_insights_upward_trend(self, analytics):
        ...
        trends = [
            TrendData(period="2024-01", value=100, change=10, change_percent=11.0, trend="up")
        ]
    ...
    def test_generate_insights_downward_trend(self, analytics):
        ...
        summary = {'total_services': 100, 'avg_rate': 50.0, 'median_rate': 50.0}
        trends = [
            TrendData(period="2024-01", value=90, change=-10, change_percent=-10.0, trend="down")
        ]
    ...
    def test_generate_recommendations_limited_regions(self, analytics):
        ...
        summary = {
            'total_services': 100,
            'services_by_region': {'EU': 100}  # Only one region
        }
