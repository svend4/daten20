...
from .financial import CostBreakdown, FinancialParameters
...
class Service:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "funding": {"payer": self.funding.payer, "documents": self.funding.documents},
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "Service":
        ...
        if "funding" in data:
            fund = data["funding"]
            service.funding = Funding(payer=fund.get("payer", ""), documents=fund.get("documents", []))
