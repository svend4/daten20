...
class StatisticalDetector:
    ...
    def detect_zscore(self, record: Dict[str, Any], threshold: float = 3.0) -> List[Anomaly]:
    ...
    def detect_iqr(self, record: Dict[str, Any], multiplier: float = 1.5) -> List[Anomaly]:
...
class PatternDetector:
    ...
    def detect_pattern_deviation(self, data: List[Dict[str, Any]], field: str) -> List[Anomaly]:
...
class DataQualityValidator:
    ...
    def add_rule(self, field: str, rule_type: str, params: Dict[str, Any]):
        """Add validation rule"""
        self.rules[field].append({"type": rule_type, "params": params})
...
class AnomalyDetectionEngine:
    ...
    def detect_anomalies(self, record: Dict[str, Any], methods: Optional[List[str]] = None) -> List[Anomaly]:
