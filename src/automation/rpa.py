...
class RPAEngine:
    ...
    def create_template_bot(self, template_name: str) -> Optional[str]:
        ...
        if template_name == "invoice_processor":
            ...
            # Add actions
            self.add_action(bot_id, ActionType.EXTRACT_DATA, {
                'source': 'invoice_folder',
                'pattern': r'invoice_(\d+).pdf'
            })

            self.add_action(bot_id, ActionType.DATABASE_QUERY, {
                'query': 'INSERT INTO invoices ...'
            })

            self.add_action(bot_id, ActionType.SEND_EMAIL, {
            ...
            self.add_action(bot_id, ActionType.API_CALL, {
