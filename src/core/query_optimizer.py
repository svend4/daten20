...
class QueryOptimizer:
    ...
    def get_table_info(self, table_name: str) -> Dict[str, Any]:
        ...
        with self.get_connection() as conn:
            ...
            return {
                ...
                "row_count": row_count,
                "indexes": [{"name": idx[1], "unique": bool(idx[2]), "origin": idx[3]} for idx in indexes],
            }
    ...
    def measure_query_performance(self, query: str, params: Tuple = (), iterations: int = 1) -> QueryPerformance:
        """
    ...
    def get_performance_report(self) -> Dict[str, Any]:
        ...
        report = {
            ...
            "average_execution_time": (
                sum(q.execution_time for q in self.query_log) / len(self.query_log) if self.query_log else 0
            ),
